---
title: "MA of pollution impacts on bird plumage colouration"
...
Raw data (both the "biological" and "physical" effect sizes) can be downloaded from [this](https://github.com/szymekdr/colour-pollution-MA/raw/main/data/data_plumage_pollution_MA.zip) link. The files is a compressed archive with all datasets and the phylogenetic tree `birdtree.tre`.
:::
