...
pacman::p_load(
    here, ggplot2, ggpubr, packcircles, metafor, devtools, orchaRd,
    metaAidR, patchwork, tidyverse, ape,
    R.rsp, emmeans
)
...
#| fig-cap: Orchard plot of the impact of pollution on avian colour traits as a function of the colour-producing mechanism conditioned for the measurement method (Nakagawa et al. 2023)
#| code-fold: true
...
```{r}
#| label: fig-fig3
#| fig-cap: Bubble plot showing a positive significant temporal trend in trend in published effect size estimates
#| code-fold: true
...
```{r}
#| label: fig-figS4
#| fig-cap: Funnel plot of effect sizes from the biology ES data set versus standard errors of effect sizes
#| code-fold: true
